...
export class Scope<ParamsKey extends string> {
  ...
  getValue(this: Scope, key: ParamsKey, scope?: Scope): unknown
  getValues<const T extends ParamsKey[]>(this: Scope, keys: T, scope?: Scope): {
  ...
  getStringValue(this: Scope, key: ParamsKey, scope?: Scope): string
  getNumberValue(this: Scope, key: ParamsKey, scope?: Scope): number
  getBooleanValue(this: Scope, key: ParamsKey, scope?: Scope): boolean | number

  getField(this: Scope, key: ParamsKey, scope?: Scope): unknown
  getStringField(this: Scope, key: ParamsKey, scope?: Scope): string
  getNumberField(this: Scope, key: ParamsKey, scope?: Scope): number

  getStatement(this: Scope, key: ParamsKey, scope?: Scope): typeof STATIC.BREAK | typeof STATIC.CONTINUE

  _getParamIndex(this: Scope, key: ParamsKey, scope?: Scope): number
  _getStatementIndex(this: Scope, key: ParamsKey, scope?: Scope): number
